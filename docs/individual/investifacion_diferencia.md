...
## Página web
La diferencia entre una página web y una aplicación web radica principalmente en el nivel de interacción y funcionalidad que ofrecen al usuario. Una página web está diseñada para mostrar información de forma mayormente estática, es decir, su objetivo principal es informar. El usuario puede leer contenido, ver imágenes o consultar datos, pero la interacción es mínima y no suele implicar procesamiento complejo de información. Este tipo de páginas se utiliza comúnmente para sitios institucionales, blogs, portafolios o páginas informativas, donde los cambios de contenido no son constantes y no se requiere autenticación avanzada.
...
## Doctoralia
Gestiona citas médicas, disponibilidad de profesionales de la salud y recordatorios automáticos para pacientes mediante un sistema web centralizado.
...
## Backend
Corresponde a la parte interna de la aplicación web, aquella que no es visible para el usuario pero que resulta esencial para el funcionamiento del sistema. En el backend se procesa la información enviada desde el frontend, se validan los datos ingresados, se aplican las reglas de negocio y se gestiona la comunicación con la base de datos. Además, esta capa se encarga de la autenticación de usuarios, el manejo de permisos y la seguridad de la información. El backend permite que la aplicación web realice operaciones complejas y mantenga la coherencia de los datos, funcionando como el núcleo lógico del sistema.
...
Son estructuras de navegación comunes y fáciles de reconocer, como menús superiores, laterales o pestañas. Estos patrones permiten moverse de forma intuitiva entre secciones, reduciendo la curva de aprendizaje y mejorando la experiencia del usuario.

## Orden de tabulación
Es la secuencia en que los elementos reciben el enfoque al usar la tecla Tab. Debe seguir un orden lógico (de arriba hacia abajo y de izquierda a derecha) para facilitar la navegación sin mouse y el uso de lectores de pantalla.

## Navegación por teclado
Permite utilizar una aplicación web únicamente con el teclado mediante teclas como Tab, Enter y flechas. Es esencial para usuarios con discapacidad motora o visual y garantiza una interacción accesible.

## Accesibilidad sin mouse
Implica que el sistema pueda usarse completamente sin ratón. Todos los elementos deben ser accesibles por teclado y estar bien etiquetados, con buen contraste y textos claros. Esto mejora la inclusión y la usabilidad general del sistema.